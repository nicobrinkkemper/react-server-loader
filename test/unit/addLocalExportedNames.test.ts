...
import { addLocalExportedNames } from "../../src/directives/addLocalExportedNames.js";
import type { ExportInfo } from "../../src/directives/types.js";

// Unit coverage for the export-collection helper. This logic moved here from
// vite-plugin-react-server when vprs became a thin adapter over rsl; the tests
// moved with it so the helper keeps direct coverage in the repo that owns it.
